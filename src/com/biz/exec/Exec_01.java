...
public class Exec_01 {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(intNum==1) System.out.println("나머지 1");
			if(intNum==2) System.out.println("나머지 2");
			if(intNum==3) System.out.println("나머지 3");
			if(intNum==4) System.out.println("나머지 4");
